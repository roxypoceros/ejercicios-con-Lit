...
super es el constructor de la clase padre. */
  ...
  render() {
    return html`
      ...
      <h4>Llega a 5 clics o a 0 y se lanzará un mensaje</h4>
...
//     }
//   }
/* Código optimizado con un getter, cuando lo llamen voy a hacer un return 
de la linea que se repite en add() y substract() */
...
add() {
  this.counter++;
  if (this.counter === 5) {
  /* A this.feedback le pido hacer el open  */
      this.feedback.open("¡¡Llegaste a 5 clics!!")
  }}
substract() {
  this.counter--;
  if (this.counter === 0) {
      this.feedback.open("¡¡Legaste a 0!!")
  }}
